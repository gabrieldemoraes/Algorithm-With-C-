...
namespace raii
{
    ...
    {
        using internal::invoke_catching_runtime_error;
        ...
        const char* filename4 = "_strings4.temp.txt";
        ...
        written = 0;
        write_strings_to_file_raii_heap_1(filename3, ss, written);
        //invoke_catching_runtime_error(write_strings_to_file_raii_heap_1, filename3, ss, written);
        std::cout << written << " strings written\n";

        written = 0;
        write_strings_to_file_raii_heap_2(filename4, ss, written);
        //invoke_catching_runtime_error(write_strings_to_file_raii_heap_2, filename4, ss, written);
        std::cout << written << " strings written\n";
    }
}
